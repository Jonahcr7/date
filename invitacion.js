...
// Show the first gif
document.getElementById('burbujaPinta').style.display = 'block';
...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'Es que yo a ti te quiero mucho!';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noBtnState) {
        case 0:
            ...
            document.getElementById('burbujaPinta').style.display = 'none';
            document.getElementById('burbujaTriste').style.display = 'block';
            ...
            document.getElementById('siBtn').style.padding = '20x 40px';
        ...
        case 1 :
            ...
            document.getElementById('siBtn').style.padding = '30x 50px';
        ...
        case 2:
            // User clic on "No"
            document.getElementById('burbujaTriste').style.display = 'none';
            document.getElementById('burbujaLlora').style.display = 'block';
            // Changes on the 'No' button
            document.getElementById('noBtn').innerHTML = '¿Estás realmente segura?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            // Changes on the 'Yes' button
            document.getElementById('siBtn').style.fontSize = '60px';
            document.getElementById('siBtn').style.padding = '40x 60px';
        ...
        case 3:
            ...
            document.getElementById('siBtn').style.padding = '60x 80px';
        ...
        case 4:
            ...
            document.getElementById('siBtn').style.padding = '80x 100px';
        ...
        case 5:
            // User clic on "No"
            document.getElementById('burbujaLlora').style.display = 'none';
            document.getElementById('burbujaEnojada').style.display = 'block';
            // Changes on the 'No' button
            document.getElementById('noBtn').innerHTML = 'DI QUE SÍÍÍ:(';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            // Changes on the 'Yes' button
            document.getElementById('siBtn').style.fontSize = '140px';
            document.getElementById('siBtn').style.padding = '120x 140px';
        ...
        case 6:
            ...
            document.getElementById('siBtn').style.padding = '160x 180px';
        ...
        case 7:
            ...
            document.getElementById('siBtn').style.padding = '220x 240px';
        ...
        case 8:
            ...
            document.getElementById('siBtn').style.padding = '300x 320px';
